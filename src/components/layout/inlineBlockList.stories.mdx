...
<Preview>
  <Story name="Chips list">
    <InlineBlockList
      items={[
        <Chip key="horses" onClose={noop} label="Horses" theme="outline" />,
        <Chip key="wombats" onClose={noop} label="Wombats" theme="outline" />,
        <Chip key="seals" onClose={noop} label="Seals" theme="outline" />,
        <Chip key="dogs" onClose={noop} label="Dogs" theme="outline" />,
      ]}
    />
  </Story>
</Preview>

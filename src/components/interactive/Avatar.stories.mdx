...
Supports 1-2 initials, a image url, which will fall back to initials if the image does not load, and 
all color classnames that FDS supports (e.g. `color--aqua`)

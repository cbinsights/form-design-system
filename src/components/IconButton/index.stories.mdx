...
<Meta title="Components/IconButton" decorators={[withKnobs]} component={IconButton} />

# IconButton

<ImportPath component={IconButton} />
...
<Preview>
  <Story name="Caret">
    <StoryWrapper>
      <StoryItem>
        <IconButton hasCaret Icon={Icons[0]} />
      </StoryItem>
      <StoryItem>
        <IconButton hasCaret Icon={Icons[1]} />
      </StoryItem>
    </StoryWrapper>
  </Story>
</Preview>

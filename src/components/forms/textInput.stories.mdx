...
import { Info, State, arrayToOptions } from 'components/util/storybook';
...
<Meta title="Components/Forms/TextInput" decorators={[withKnobs]} component={TextInput} />
...
You should be able to use this input in any form management library you'd like:

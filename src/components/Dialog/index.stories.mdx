...
export default {
  ...
  parameters: {
    docs: {
      page: Layout,
      description: {
        component: 'An accessible base modal for all other modals to be built upon (either your own, or other FDS modals like `<Prompt />`). **Please click "Canvas" to view examples**.',
      },
    },
  },
};

...
import { arrayToOptions, storyBackgrounds, ImportPath } from 'components/util/storybook';

import Section, { VALID_BG_NORMAL, VALID_BG_INVERTED, VALID_PADDING } from './';
...
<Meta title="Components/Section" decorators={[withKnobs]} component={Section} />

# Section

<ImportPath component={Section} />

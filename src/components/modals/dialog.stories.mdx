  ...
  <Dialog
    ...
    subheader={
      <div className="alignChild--left--center">
        <span className="margin--right--half">Subheader can render any custom JSX:</span>
        <Chip label="Lorem" size="s" />&nbsp;
        <Chip label="Ipsum" size="s" />&nbsp;
        <Chip label="Dolor" size="s" />&nbsp;
      </div>
    }
  />
</Story>

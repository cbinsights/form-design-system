...
<Meta title="FDS|Modals/Dialog" decorators={[withKnobs]} component={Dialog} parameters={{ docs: { disable: true } }}/>
...
*PropType table is broken for this component at the moment. 
Theres tons of reported regressions of this table not working
that need to be fixed: *
https://github.com/storybookjs/storybook/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%22block%3A+props%22+label%3Abug

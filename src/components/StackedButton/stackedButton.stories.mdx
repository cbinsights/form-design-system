...
import ShareIcon from 'lib/icons/react/ShareIcon';
...
<Meta title="Components/StackedButton" decorators={[withKnobs]} component={StackedButton} />
...
<Story name="Example">
  <div className="padding--all alignChild--right--center" style={{ backgroundColor: "#f1f5f7" }}>
    <div>
      <StackedButton
        Icon={CloneIcon}

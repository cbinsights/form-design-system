...
when it shows. If you type into the text area, then click th body to leave it, then
...
This is a similar attempt at the same funcitonality but using `interactionMode="click"`

...
Displays an Avatar, consisting of a background image and intials as a baseline, or
an image displayed at the same dimensions (the initials being a fallback if the image does not load)

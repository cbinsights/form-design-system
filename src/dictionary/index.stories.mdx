...
import { colors, layouts, fonts, borders, motions } from '../../lib/dictionary/js/manifest.js';
...
<Story name="Color">
  <ColorSwatchWrapper>
    {colors.map(({ varNames, values }) => (
      <ColorSwatch name={varNames.human} hex={values.hex} cssVar={varNames.css} jsVar={varNames.js} />
    ))}
  </ColorSwatchWrapper>
</Story>
...
<Story name="Layout">
  <TableLayout
    ...
    rows={layouts.map(({ varNames, value }) => ([
      varNames.css,
      varNames.js,
      value,
    ]))}
...
<Story name="Font">
  <TableLayout
    shrinkLastColumn
    headers={['CSS VAR', 'JS VAR', 'VALUE']}
    rows={fonts.map(({ varNames, value }) => ([ varNames.css, varNames.js, value ]))
      .map(row => {
...
<Story name="Border">
  <TableLayout
    shrinkLastColumn
    headers={['CSS VAR', 'JS VAR', 'VALUE']}
    rows={borders.map(({ varNames, value }) => ([ varNames.css, varNames.js, value]))
      .map(row => {
...
<Story name="Motion">
  <TableLayout
    shrinkLastColumn
    headers={['CSS VAR', 'JS VAR', 'VALUE']}
    rows={motions.map(({ varNames, value }) => ([
      varNames.css,
      varNames.js,
      value,
    ]))}

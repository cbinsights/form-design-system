...
*Banners should only be used to convey important messages. If there is something
actionable for the user, include a link or button in the banner.*
...
*Toasts animate up from the bottom left of the viewport. By default, a Toast notification
will dismiss itself after about four seconds.*

### Giving users time to read
...
*A Prompt is a modal dialog that solicits user feedback. Prompts are typically used to
...
<CopyExample
  invalid="Yes, delete Collection"
  valid="Delete Collection"
/>

### Give the user a way out
- **All user responses should close the prompt immeidately**
